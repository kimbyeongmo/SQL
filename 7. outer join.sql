...
SELECT
    *
FROM tb_emp E
LEFT JOIN tb_dept D  -- OUTER 생략 가능
ON E.dept_cd = D.dept_cd
;
...
-- 부서에 소속된 사원이 41명
-- 사원이 존재하는 부서 14개
-- INNER JOIN의 사원정보조회 결과 41건 
-- LEFT OUTER JOIN : INNER JOIN 41건 + 부서가 없는 사원 5건 = 46건
-- RIGHT JOIN : INNER JOIN 41건 + 사원이없는 부서 2건 = 43건
-- FULL JOIN : INNER JOIN 41건 + 5 + 2 = 48건
