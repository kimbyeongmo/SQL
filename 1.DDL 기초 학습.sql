...
ALTER TABLE tbl_score ADD CONSTRAINT pk_tbl_score PRIMARY KEY(stu_num);

-- PK를 제거
ALTER TABLE tbl_score DROP CONSTRAINT pk_tbl_score;
...
-- TRUNCATE : 구조는 남기고 안에 데이터만 삭제하여 테이블이 생성된 초기 상태로 돌아간다.
